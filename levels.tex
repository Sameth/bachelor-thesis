...
tak, aby obsahoval eulerovský ťah. Tento prístup funguje preto, že každý sled priamo
zodpovedá eulerovskému ťahu pre nejaké doplnenie hrán do grafu.

Súvislý orientovaný graf je eulerovský práve vtedy, keď do každého vrchola vchádza toľko hrán,
koľko z neho vychádza. 
