...
podreťazec \texttt{CGAC}, ktorý sa nevyskytuje ani v jednom z pôvodných čítaní.
...
Pre daný krátky podreťazec $r$ môžeme mať viacero výskytov, ktoré zodpovedajú
